...
Figure \ref{fig:waveforms} shows the isolated outputs of the string (where $l = \text{floor}((L-x_\text{sm})h)$), the  bowed at $x_\text{b} = 0.3L$, with $v_\text{b} = 0.2$
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\columnwidth]{trombaWaveforms.eps}
  \caption{The isolated outputs of the string, bridge and plate at 0.5 gain.}
  \label{fig:waveforms}
\end{figure}
