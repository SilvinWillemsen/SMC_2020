...
\begin{figure}[h]
  ...
  \caption{The application with text highlighting different components.}
  \label{fig:application}
\end{figure}

\subsection{Sensel Morph and Mapping}
The Sensel is an expressive touch controller using \texttildelow20,000 pressure sensitive sensors laid out in an hexagonal grid\cite{sensel2020}. It retrieves x and y positions and pressure from which it calculates velocities and accelerations.
